...
class GraphQLCache {
    constructor({ configDir, config, parser, }) {
        ...
        this.getProjectForFile = (uri) => {
            return this._graphQLConfig.getProjectForFile(url_1.fileURLToPath(uri));
        };
            ...
            return new Promise((resolve, reject) => {
                ...
                globResult.on('end', () => {
                    resolve(Object.keys(globResult.statCache)
                        ...
                        return {
                            filePath: url_1.pathToFileURL(filePath).toString(),
        ...
        this.promiseToReadGraphQLFile = (filePath) => {
            return new Promise((resolve, reject) => fs.readFile(url_1.fileURLToPath(filePath), 'utf8', (error, content) => {
                if (error) {
                    reject(error);
                    return;
                }
